...
| UC09 | Menampilkan jumlah kuota pendaftar program. | Relawan melihat jumlah kuota pendaftar pada kolom deskripsi program. | Relawan | KF10, KF11<br><br> |
...
| UC13 | Menyimpan daftar calon relawan | Inisiator program dan verifikator menyimpan dan mengirimkan daftar calon relawan suatu program kepada lembaga yang memiliki kepemilikan terhadap program tersebut. | Inisiator program, verifikator | KF16<br> |
...
| UC16 | Menyeleksi calon relawan dalam program | Inisiator program memperoleh daftar relawan yang mendaftar pada programnya dan memilih status *Diterima* atau *Ditolak* setiap nama dalam daftar lalu menyimpannya. | Inisiator program | KF17, KF18, KF19<br> |
...
| UC19 | Menerima dan memeriksa waktu *check-in* | Verifikator menerima, melihat, dan mencatat waktu *check-in* relawan saat program dilaksanakan dengan validitas waktu selama rentang waktu keberjalanan program. | Verifikator | KF22, KF23, KF24, KF25, KF26<br> |
...
| UC21 | Mengunggah dokumentasi program | Inisiator program mengunggah dokumentasi akhir kegiatan setelah program dinyatakan selesai pada web. | Inisiator program | KF27<br> |
| UC22 | Melihat dokumentasi program | Relawan melihat dokumentasi program pada kolom informasi program-program yang telah terlaksana pada web. | <br> | <br> |
...
| UC24 | Melihat status keberjalanan kegiatan | Relawan melihat status keberjalanan program di kolom informasi program terkait pada web | Relawan | K28, K29<br> |
...
| UC27 | Melihat akumulasi jam aksi | Relawan memperoleh pembaruan akumulasi jam aksi setelah program yang terverifikasi telah diikutinya dinyatakan *Selesai.* | Relawan | K30<br> |
