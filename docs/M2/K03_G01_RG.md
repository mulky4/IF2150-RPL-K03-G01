...
| *R08* | *A06* | *System* | Sistem harus menolak pendaftaran baru secara otomatis apabila kuota relawan suatu program sudah terpenuhi. | |
| *R09* | *A07* | *User* | Akun milik pengunjung web sudah dilengkapi dengan data diri dan telah terverifikasi oleh admin RekanBumi. | |
| *R10* | *A07* | *Business* | Lembaga memiliki setidaknya beberapa data diri dasar terkait pendaftar, yaitu nama lengkap, kontak yang aktif, domisili, dll. | |
| *R11* | *A08* | *System* | Web RekanBumi harus memiliki menu khusus untuk melakukan konfirmasi kehadiran fisik relawan yang telah mendaftarkan diri sebelumnya. | |
| *R12* | *A08* | *System* | Sistem membatasi akses fitur check in hanya pada rentang waktu pelaksanaan kegiatan sesuai jadwal program. | |
| *R13* | *A09* | *Business* | Lembaga harus melakukan konfirmasi kepada sistem RekanBumi mengenai ketercapaian dan status penyelesaian untuk penutupan status kegiatan dari program-program yang didaftarkan pada web RekanBumi. | |
| *R14* | *A09* | *Business* | Lembaga harus melakukan pengunggahan dokumentasi akhir berupa foto keadaan di lapangan setidaknya setelah program berakhir. | |
| *R15* | *A09* | *System* | Sistem wajib menyediakan fitur unggah dokumentasi akhir serta tombol untuk mengubah status kegiatan menjadi selesai. | |
| *R16* | *A10* | *System* | Sistem wajib secara otomatis mencatat riwayat jam aksi dan program yang diikuti ke profil portofolio relawan setelah kegiatan berstatus selesai. | |
| *R17* | *A10* | *System* | Sistem wajib mengarsipkan dan menampilkan ringkasan capaian dampak lingkungan (misal total bibit ditanam, sampah terkumpul) dari tiap program pada halaman publik. | |
